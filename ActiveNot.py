...
print(contract.functions.isActive().call())

#invoke the transaction to change the state
...
tx = contract.functions.active().buildTransaction({
    "from":acct.address,
    "nonce":nonce
...
print("gasUsed={gasUsed}". format(**tx_receipt))
